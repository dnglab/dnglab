...
use super::{
    colortype::ColorType, encoder::DirectoryEncoder, encoder::TiffKind, error::DngResult, tags,
    tags::ResolutionUnit, tags::Tag, Rational, TiffValue,
};

pub struct CfaImageEncoder<'a, W: 'a + Write + Seek, C: ColorType, K: TiffKind> {
...
impl<'a, W: 'a + Write + Seek, T: ColorType, K: TiffKind> CfaImageEncoder<'a, W, T, K> {
    pub(crate) fn new(
