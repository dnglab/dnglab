...
impl RawSource {
  ...
  pub fn subview(&self, offset: u64, size: u64) -> std::io::Result<&[u8]> {
    self
      ...
      .ok_or(std::io::Error::new(std::io::ErrorKind::UnexpectedEof, "buf end"))
  }

  pub fn subview_opt(&self, offset: u64, size: u64) -> std::io::Result<PaddedBuf> {
  ...
  pub fn subview_until_eof_opt(&self, offset: u64) -> std::io::Result<PaddedBuf> {
