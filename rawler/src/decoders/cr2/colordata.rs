  ...
  match &colordata.value {
    ...
    Value::Short(data) => {
      ...
      Ok(match version {
        ...
        65 => ColorData::new(data, version, 0x69, Some(0x17f), Some(0x294), Some(0x295)),

        // 66 (R6MK3)
        66 => ColorData::new(data, version, 0x69, Some(0x17f), Some(0x294), Some(0x295)),
        67 => ColorData::new(data, version, 0x69, Some(0x17f), Some(0x294), Some(0x295)),
