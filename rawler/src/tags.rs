...
pub trait TiffTagEnum : Into<u16> + TryFrom<u16> + Debug + Sized + Copy {

}

impl TiffTagEnum for u16 {}
...
impl Into<u16> for ExifGpsTag {
    fn into(self) -> u16 {
        self as u16
    }
}

impl TiffTagEnum for ExifGpsTag {}
...
impl TiffTagEnum for DngTag {}


impl TryFrom<u16> for DngTag {
    type Error = String;
