...
set edit:completion:arg-completer[dnglab] = {|@words|
    ...
    var completions = [
        ...
        &'dnglab;convert'= {
            ...
            cand --jxl-distance 'JPEG XL distance (0.0 = lossless, 1.0 = visually lossless)'
            cand --jxl-effort 'JPEG XL encoding effort (1 = fast, 10 = best quality)'
            cand --jxl-decode-speed 'JPEG XL decode speed hint (1 = slow, 4 = fast)'
